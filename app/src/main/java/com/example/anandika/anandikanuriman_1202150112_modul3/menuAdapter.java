...
/**
 * Created by Anandika on 25/02/2018.
 */

public class menuAdapter extends RecyclerView.Adapter<menuAdapter.menuholder> {
    CardView cd;
    private Context context;
    private List<Pilih_Air> listmenu;

    public menuAdapter (Context context, List<Pilih_Air> listmenu){
    ...
    public void onBindViewHolder (menuholder holder, int position) {
        Pilih_Air data = listmenu.get(position);
        ...
        public menuholder(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent ganti = new Intent(context, Detail_Air.class);
